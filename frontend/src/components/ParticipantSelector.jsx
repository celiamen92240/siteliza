    ...
    <div className="space-y-1.5 text-left">
      ...
      <div className="flex items-center gap-2">
        ...
        <div ref={dropdownRef} className="relative flex-1">
          ...
          {isOpen && (
            <div className="absolute top-full left-0 right-0 mt-1.5 z-50 bg-white rounded-2xl shadow-2xl border-2 border-blush-200 p-1.5 space-y-1 max-h-72 overflow-y-auto animate-in fade-in zoom-in-95">
