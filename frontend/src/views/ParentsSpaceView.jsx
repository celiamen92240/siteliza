            ...
            <div className="bg-[#FFF5F7] rounded-3xl p-4.5 shadow-xs border-2 border-[#FECDD3] space-y-3">
              ...
              <form onSubmit={(e) => handleAddPersonItem(e, 'Séjour Maternité (Maman)', inlineNewLiza, setInlineNewLiza)} className="flex items-center gap-2 pt-1">
                <input
                  ...
                  className="flex-1 px-3 py-2 rounded-xl border border-rose-200 text-xs bg-white text-slate-800 focus:outline-none focus:ring-2 focus:ring-blush-400"
                />
                <button
                  type="submit"
            ...
            <div className="bg-[#F5F8FF] rounded-3xl p-4.5 shadow-xs border-2 border-[#BFDBFE] space-y-3">
              ...
              <form onSubmit={(e) => handleAddPersonItem(e, 'Papiers & Pratique (Papa)', inlineNewClement, setInlineNewClement)} className="flex items-center gap-2 pt-1">
                <input
                  ...
                  className="flex-1 px-3 py-2 rounded-xl border border-blue-200 text-xs bg-white text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-400"
                />
                <button
                  type="submit"
                  className="w-8 h-8 rounded-xl bg-blue-500 text-white flex items-center justify-center shadow-xs cursor-pointer active:scale-95 flex-shrink-0"
                  title="Ajouter"
                >
                  <Plus className="w-4 h-4 stroke-[3px]" />
                </button>
                      ...
                      >
                        <div className="flex items-center justify-between gap-2 mb-3.5 px-1">
                          {idx === 0 ? (
                            <span className={`text-[8.5px] font-black uppercase tracking-wider px-2.5 py-1 rounded-full border shrink-0 flex items-center gap-1.5 whitespace-nowrap leading-none ${
                              isCurrentActive
                                ? 'text-blush-700 bg-rose-100 border-blush-200 shadow-2xs'
                                : 'text-slate-500 bg-slate-100 border-slate-200'
                            }`}>
                              <Sparkles className="w-3 h-3 text-blush-600 flex-shrink-0" />
                        ...
                        <div className="flex items-start gap-3.5 px-1">
                          ...
                          <div className="space-y-2 flex-1 min-w-0">
                            <h4 className={`font-serif text-xs sm:text-sm font-extrabold leading-snug break-words ${isCurrentActive ? 'text-slate-800' : 'text-slate-600'}`}>
                              {rdv.title}
                            </h4>

                            <div className="flex flex-wrap items-center gap-2 text-[11px] font-bold text-blush-600">
